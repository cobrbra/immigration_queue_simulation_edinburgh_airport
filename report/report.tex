...
This document contains the results of Jacob and Bella's project to submit to the modelling competition. It should be ten pages or fewer. \jbnote{including references?} \bdnote{I would include the refs in the 10 pages -- rather make the font size smaller and avoid any discussion!}
